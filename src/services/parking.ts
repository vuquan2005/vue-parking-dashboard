...
export const Parking: MessageFns<Parking> = {
  ...
  fromPartial<I extends Exact<DeepPartial<Parking>, I>>(object: I): Parking {
    const message = createBaseParking();
    message.wifiScanning = (object.wifiScanning !== undefined && object.wifiScanning !== null)
      ? WifiScanning.fromPartial(object.wifiScanning)
      : undefined;
    message.scanResults = (object.scanResults !== undefined && object.scanResults !== null)
      ? ScanResults.fromPartial(object.scanResults)
      : undefined;
    message.wifiStatus = (object.wifiStatus !== undefined && object.wifiStatus !== null)
      ? DeviceStatus.fromPartial(object.wifiStatus)
      : undefined;
    message.parkingStatus = (object.parkingStatus !== undefined && object.parkingStatus !== null)
      ? ParkingStatus.fromPartial(object.parkingStatus)
      : undefined;
    message.parkingEvent = (object.parkingEvent !== undefined && object.parkingEvent !== null)
...
export const ParkingEvent: MessageFns<ParkingEvent> = {
  encode(message: ParkingEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const ScanResults: MessageFns<ScanResults> = {
  encode(message: ScanResults, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.accessPoints.push(ScanResults_AP.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<ScanResults>, I>>(object: I): ScanResults {
    const message = createBaseScanResults();
    message.accessPoints = object.accessPoints?.map((e) => ScanResults_AP.fromPartial(e)) || [];
    return message;
  },
};
...
export const ScanResults_AP: MessageFns<ScanResults_AP> = {
  encode(message: ScanResults_AP, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ssid !== "") {
  ...
  fromJSON(object: any): ScanResults_AP {
    return {
      ...
      encryption: isSet(object.encryption) ? scanResults_WifiAuthModeFromJSON(object.encryption) : 0,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ScanResults_AP>, I>>(object: I): ScanResults_AP {
    const message = createBaseScanResults_AP();
